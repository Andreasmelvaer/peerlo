...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      "Behovet for støtte følger ikke arbeidstiden. Det dukker opp på søndagskvelden før en tøff arbeidsuke. På en onsdag ettermiddag når arbeidsdagen er over og du ikke lenger har noe å distrahere deg med. I en ferie som egentlig skulle være avkobling, men som i stedet gir for mye tid til egne tanker. Eller bare midt på natten, når hodet ikke vil la deg sove.",
      "Det er sjelden i det øyeblikket folk har det som verst at de klarer å navigere seg til riktig hjelp. Da trenger de noen som er der – ikke en venteliste, ikke et tastevalg, ikke beskjed om å ringe tilbake i åpningstiden.",
      "Det er der folk gir opp. Og det er der problemene vokser seg store nok til å bli sykefravær.",
      "## Det koster deg mer enn du tror",
      "Ansatte som til slutt blir sykemeldt med en psykisk diagnose er borte i gjennomsnitt 76,5 dager per tilfelle. I tillegg kommer presenteisme – ansatte som møter opp men ikke fungerer på topp – som ifølge forskning koster 2–3 ganger mer enn selve fraværet.",
      "Og når ansatte til slutt slutter, koster det typisk fra 100 000 kroner og oppover å erstatte dem. Psykisk helse er langt oftere en underliggende årsak enn det som oppgis i avslutningsintervjuet.",
      "## Det er her Peerlo er annerledes",
      "Peerlo er tilgjengelig når alt annet er stengt. Ansatte snakker anonymt med likepersoner/peers – ekte mennesker som selv har stått i noe av det samme. Ikke terapi. Ikke en maskin som simulerer empati. Noen som forstår, fordi de har vært der – og som er der når det trengs.",
      "Når støtten ikke kommer fra HR, ikke fra legen og ikke fra nærmeste leder, faller mye av stigmaet bort. Folk tar steget tidligere. Og jo tidligere, jo bedre.",
