...
const posts: Post[] = [
  ...
  },
  {
    ...
    content: [
      "Jeg tror ikke hovedproblemet er at mennesker ikke vil ha hjelp – jeg tror problemet er at terskelen føles altfor høy. Mange går rundt med en følelse av at det ikke er alvorlig nok, at andre har det verre, at de burde klare dette selv. Så man venter, og venter litt til, ofte helt til kroppen eller hodet sier stopp.",
      "Jeg tror også mange er redde for hva det egentlig betyr å «søke hjelp». For noen føles det stort, nesten dramatisk – som å innrømme nederlag, som å miste kontroll, eller som å måtte sette ord på noe man knapt forstår selv.",
      "Og kanskje er det nettopp derfor peer support kan være lettere for mange. For det føles ofte mer menneskelig – mer som «kan jeg bare få snakke med noen som skjønner litt?», i stedet for «jeg trenger behandling». Det er en stor forskjell.",
      "Når man møter noen med egenerfaring, senkes ofte skuldrene litt. Man slipper følelsen av å måtte prestere i samtalen, og kanskje også frykten for å bli analysert eller misforstått. For det er noe eget med mennesker som faktisk har kjent på lignende ting selv – de vet hvor vanskelig det kan være å åpne seg, og hvor mye skam som ofte ligger bak. Hvor slitsomt det egentlig er å late som alt er fint.",
      ...
      "Jeg tror mange mennesker kunne fått hjelp mye tidligere dersom terskelen føltes lavere – hvis det føltes mer normalt å si «jeg har det litt tungt om dagen», lenge før det blir «jeg klarer ikke mer». Kanskje er det nettopp der peer support kan gjøre den største forskjellen.",
