...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      "Og det er akkurat der jeg tror [peer support](/blog/hva-er-peer-support) kan gjøre en enorm forskjell.",
  ...
  },
  {
    ...
    content: [
      ...
      "Men noen ganger merker man ganske raskt om personen foran deg virkelig forstår følelsen, eller bare prøver å forstå den.",
      ...
      "Det er kanskje nettopp derfor [peer support](/blog/hva-er-peer-support) kan oppleves så annerledes.",
      ...
      "Og kanskje er det nettopp derfor så mange [åpner seg lettere](/blog/apne-deg-forste-gang) for mennesker med egenerfaring.",
  ...
  },
  {
    ...
    content: [
      ...
      "Det handler mer om støtte. Gjenkjennelse. Håp.\nÆrlige samtaler og følelsen av å bli forstått.",
      "Noen ganger kan det faktisk være lettere å [åpne seg](/blog/apne-deg-forste-gang) for noen med egenerfaring enn for venner eller familie.",
      "Hvorfor?",
  ...
  },
  {
    ...
    content: [
      ...
      "Det kan føles som å innrømme nederlag.\nSom å miste kontroll.\nEller som å måtte sette ord på noe man knapt forstår selv.",
      "Og kanskje er det nettopp derfor [peer support](/blog/hva-er-peer-support) kan være lettere for mange.",
      ...
      "De vet ofte hvor vanskelig det kan være å [åpne seg](/blog/apne-deg-forste-gang).\nOg hvor mye skam som kan ligge bak.\nHvor slitsomt det er å late som alt går fint.",
  ...
  },
  {
    ...
    content: [
      ...
      "Og jo lenger man [går alene med det](/blog/alene-for-lenge), jo vanskeligere kan det bli å åpne seg.",
  ...
  },
  {
    ...
    content: [
      ...
      "De vet kanskje hvordan det er å late som alt går fint.\nHvordan det er å trekke seg unna mennesker.\nÅ føle seg misforstått.\nOg hvor vanskelig det kan være å be om hjelp.",
      ...
      "Man føler seg mindre rar.\nMindre alene.\nMindre «feil».",
      "Og kanskje er det nettopp derfor [peer support](/blog/hva-er-peer-support) kan fungere så godt for mange.",
  ...
  },
  {
    ...
    content: [
      ...
      "Jeg tror også mange undervurderer hvor mye håp som kan ligge i å møte [noen som har vært langt nede selv](/blog/vanlig-menneske-hjelpe), og fortsatt står oppreist.",
      ...
      "Kanskje handler det mer om å føle seg sett.\nÅ føle seg trygg.\nÅ tørre å være ærlig.",
  ...
  },
  {
    ...
    content: [
      ...
      "For sannheten er at mange som sliter psykisk fortsatt går på jobb. Trener. Smiler. Leverer. Svarer «det går fint».",
      ...
      "Et menneske som kanskje vet hvordan det er å smile når man egentlig har det tungt.\nÅ fungere på jobb mens hodet er kaos.\nOg å føle seg alene midt blant andre mennesker.",
      "Jeg tror også mange unge voksne kunne hatt stor nytte av [peer support](/blog/hva-er-peer-support).",
      "Spesielt i en tid der mange føler press, sammenligning, ensomhet og frykten for å ikke strekke til.\nSamtidig som alt ser perfekt ut på utsiden.",
  ...
  },
  {
    ...
    content: [
      ...
      "Jeg tror også mange [venter altfor lenge](/blog/hvorfor-hjelp-for-sent) før de åpner seg.",
      ...
      "Det er derfor jeg tror tidlig [støtte fra noen som forstår](/blog/hva-er-peer-support) betyr så mye.",
  ...
  },
  {
    ...
    content: [
      ...
      "Mennesker som fungerer på jobb.\nSmiler til andre.\nSvarer «det går fint».",
      ...
      "Jeg tror faktisk mange hadde hatt godt av å [åpne seg mye tidligere](/blog/alene-for-lenge).\nFør alt vokser seg så stort.",
      ...
      "Og noen ganger kan det være starten på [noe viktig](/blog/etter-god-samtale).",
