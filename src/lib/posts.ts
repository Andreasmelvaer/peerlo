...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      "Rekruttering og opplæring av en ny medarbeider koster gjennomsnittlig mellom 50 000 og 200 000 kroner, avhengig av rolle. Det kommer i tillegg til produktivitetstap i perioden før vedkommende slutter, og mens en ny person lærer seg jobben.",
