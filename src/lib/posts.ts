...
const posts: Post[] = [
  {
    ...
    title: "Flere av dine ansatte sliter i stillhet. Du kan hjelpe dem.",
    excerpt: "Én av fem ansatte sliter med psykisk helse – uten å si ifra. Som arbeidsgiver kan du ikke løse alt, men du kan gjøre det enklere å få hjelp tidlig – før det blir sykefravær.",
    date: "2026-05-19",
    author: "Ole Aarre",
    readingTime: 3,
    ...
    content: [
      ...
      "## Psykisk uhelse skyldes sjelden jobben – men konsekvensene vises der",
      "Psykiske utfordringer hos ansatte handler sjelden om arbeidet i seg selv. Det kan like gjerne være et samlivsbrudd, en krevende familiesituasjon, økonomisk stress, ensomhet eller ting som har hopet seg opp over tid. Ting som ikke har noe med arbeidsplassen å gjøre.",
      "Og det er ikke din feil som arbeidsgiver.",
      "Men selv om årsaken ikke er jobb-relatert, er det på jobb konsekvensene viser seg. Konsentrasjonen svikter. Energien uteblir. Den ansatte møter opp, men er ikke helt til stede. Og over tid kan det som startet som noe privat, ende opp som langvarig sykefravær.",
      "## Eksisterende tilbud når ikke frem når det gjelder",
      "Psykolog: venteliste på uker eller måneder. Fastlege: åpner klokken åtte, stengt i helgen. Bedriftshelsetjeneste: time må bestilles, og mange tør ikke. EAP-ordning: et telefonnummer de fleste ansatte aldri ringer.",
      "Behovet for psykisk støtte følger ikke arbeidstiden. Det dukker opp på søndagskvelden før en tøff uke. Midt på natten. I en ferie som egentlig skulle være avkobling, men som gir for mye rom til egne tanker.",
      "Det er sjelden i det øyeblikket folk har det som verst at de klarer å navigere seg til riktig hjelp. Det er der folk gir opp. Og det er der problemene vokser seg store nok til å bli sykefravær.",
      "## Psykisk sykefravær og presenteisme koster mer enn du tror",
      "Ansatte som blir sykemeldt med en psykisk diagnose er borte i gjennomsnitt 76,5 dager per tilfelle – nesten tre måneder. I tillegg kommer presenteisme – ansatte som møter opp men ikke fungerer på topp – som ifølge forskning koster 2–3 ganger mer enn selve fraværet.",
      "Og når ansatte til slutt slutter, koster det typisk fra 100 000 kroner og oppover å erstatte dem. Psykisk helse er langt oftere en underliggende årsak til turnover enn det som oppgis i avslutningsintervjuet.",
      "## Peer support: lavterskel psykisk helse-støtte som faktisk når frem",
      "Du kan ikke løse det som skjer i livet til dine ansatte utenfor jobben. Det er heller ikke din oppgave.",
      "Men du kan gjøre det enklere å få hjelp tidlig – før problemene vokser seg for store. Det er der Peerlo kommer inn.",
      "Peerlo er et lavterskeltilbud innen psykisk helse for bedrifter, tilgjengelig når alt annet er stengt. Ansatte snakker anonymt med peers – ekte mennesker som selv har stått i noe av det samme. Ikke terapi. Ikke en maskin. Noen som forstår, fordi de har vært der.",
      "Når støtten ikke kommer fra HR, ikke fra legen og ikke fra nærmeste leder, faller mye av stigmaet bort. Ansatte tar steget tidligere. Jo tidligere, jo bedre – for dem og for deg.",
      "WHO har dokumentert at hver krone investert i psykisk helse gir fire kroner tilbake. Peerlo koster en fast månedlig sum per ansatt – langt rimeligere enn å håndtere eskalerte saker, lange sykmeldinger og turnover i etterkant.",
      "Som HR-ansvarlig eller leder får du aggregert, anonymisert innsikt i hva ansatte faktisk sliter med – ikke hvem, men hva. Forebyggende innsikt, ikke brannslukking.",
      "## Hva kan arbeidsgiver gjøre for psykisk helse på arbeidsplassen?",
      "Du kan ikke fikse livet til dine ansatte. Men du kan fjerne barrierene som hindrer dem i å få hjelp.",
      { items: [
        "Gjøre det trygt og anonymt å be om støtte – uten at det påvirker karrieren.",
        "Tilby hjelp som er tilgjengelig når behovet er der, ikke bare i åpningstiden.",
        "Nå ansatte som aldri ville kontaktet bedriftshelsetjenesten eller en psykolog.",
        "Jobbe forebyggende med psykososialt arbeidsmiljø, i tråd med arbeidsmiljølovens krav.",
      ]},
      "Det er det Peerlo er bygget for.",
      "[Ta kontakt med Ole og hør hvordan Peerlo kan tilpasses din bedrift.](/#kontakt)",
      "## Kilder",
