...
const posts: Post[] = [
  {
    ...
    content: [
      ...
      "## Det er sjelden jobben som er årsaken",
      "Psykiske utfordringer handler sjelden om arbeidet i seg selv. Det kan like gjerne være et samlivsbrudd, en krevende familiesituasjon, økonomisk stress, ensomhet eller ting som har hopet seg opp over tid. Ting som ikke har noe med arbeidsplassen å gjøre.",
      "Og det er ikke din feil som arbeidsgiver.",
      "Men her er det som er viktig å forstå: selv om årsaken ikke er jobb-relatert, er det fortsatt på jobb konsekvensene viser seg. Konsentrasjonen svikter. Energien uteblir. Den ansatte møter opp, men er ikke helt til stede. Og over tid kan det som startet som noe privat, ende opp som sykmelding.",
      "## Hjelpen finnes – men den er ikke tilgjengelig når den trengs",
      "Psykolog: venteliste på uker eller måneder. Fastlege: åpner klokken åtte, stengt i helgen. Bedriftshelsetjeneste: time må bestilles, og mange tør ikke. EAP-ordning: et telefonnummer de fleste aldri ringer.",
      "Behovet for støtte følger ikke arbeidstiden. Det dukker opp på søndagskvelden. Midt på natten. I en ferie som egentlig skulle være avkobling.",
      ...
      "## Det koster deg mer enn du tror",
      "Ansatte som blir sykemeldt med en psykisk diagnose er borte i gjennomsnitt 76,5 dager per tilfelle. I tillegg kommer presenteisme – ansatte som møter opp men ikke fungerer på topp – som ifølge forskning koster 2–3 ganger mer enn selve fraværet.",
      "Og når ansatte til slutt slutter, koster det typisk fra 100 000 kroner og oppover å erstatte dem.",
      "## Det er her du faktisk kan gjøre en forskjell",
      "Du kan ikke løse det som skjer i livet til dine ansatte utenfor jobben. Det er heller ikke din oppgave.",
      "Men du kan gjøre det enklere å få hjelp – før det går for langt. Det er der Peerlo kommer inn.",
      "Peerlo er tilgjengelig når alt annet er stengt. Ansatte snakker anonymt med peers – ekte mennesker som selv har stått i noe av det samme. Ikke terapi. Ikke en maskin som simulerer empati. Noen som forstår, fordi de har vært der – og som er der når det trengs.",
      "Når støtten ikke kommer fra HR, ikke fra legen og ikke fra nærmeste leder, faller mye av stigmaet bort. Folk tar steget tidligere. Og jo tidligere, jo bedre – for dem og for deg.",
      "WHO har dokumentert at hver krone investert i psykisk helse gir fire kroner tilbake. Peerlo koster en fast månedlig sum per ansatt – langt rimeligere enn å håndtere eskalerte saker i etterkant.",
      "Som HR-ansvarlig får du aggregert, anonymisert innsikt i hva ansatte faktisk sliter med – ikke hvem, men hva. Forebyggende, ikke brannslukking.",
      "## Spørsmålet er ikke om dere har råd til det",
      "Det er om dere har råd til å la være.",
