...
const posts: Post[] = [
  {
    ...
    author: "Ole Aarre",
    readingTime: 3,
    image: "/images/blog/hvorfor-peerlo-bedrift.png",
    inlineImages: [],
    relatedSlugs: [
    ...
    content: [
      "Et innlegg til deg som jobber med mennesker",
      "Du vet allerede at folk er det viktigste en bedrift har. Men visste du at norske virksomheter mister millioner hvert år på noe de knapt snakker om rundt ledermøtebordet?",
      "Det handler ikke om fravær. Det handler om alle de ansatte som møter opp – dag etter dag – uten å ha det bra.",
      "## Tallene du ikke kan se bort fra",
      "Psykiske lidelser koster Norge 280–290 milliarder kroner i året. Det er Norges dyreste sykdomsgruppe – og den som vokser raskest i sykefraværsstatistikken.",
      "Psykiske lidelser utgjorde over 2,2 millioner tapte dagsverk bare i ett kvartal i 2024 – over en fjerdedel av alle sykefraværsdagene.",
      "Og når noen først blir sykemeldt med en psykisk diagnose, varer fraværet i gjennomsnitt 76,5 dager.",
      "Det er ikke en liten utfordring i hjørnet av HMS-permen. Det er den største enkeltdriveren av langtidsfravær i norsk arbeidsliv.",
      "## Det synlige er bare toppen",
      "Fraværstallene forteller bare halve historien. Den andre halvdelen er presenteisme – ansatte som møter opp, men ikke fungerer på topp. Forskning tyder på at produktivitetstapet fra presenteisme er 2–3 ganger høyere enn fra faktisk fravær. De ansatte du bekymrer deg minst for, kan koste mest.",
      "Og rundt 16–22 prosent av den voksne befolkningen oppfyller kriteriene for en psykisk lidelse i løpet av ett år. I en bedrift med 50 ansatte betyr det at opptil ti personer kan slite med noe de ikke har sagt ifra om.",
      "## Terskelen er det egentlige problemet",
      "Du kan ha verdens beste HMS-system og likevel nå for få. Fordi mange ansatte aldri ringer det nummeret, aldri bestiller den timen. Ikke fordi de ikke trenger hjelp – men fordi terskelen er for høy. De er redde for hva det betyr for karrieren, for hvordan kolleger ser på dem, for å virke svake.",
      "Det er der Peerlo gjør noe annet.",
      "## Hva er Peerlo – og hvorfor er det annerledes?",
      "Peerlo er et lavterskeltilbud der ansatte kan snakke anonymt med erfaringskonsulenter – ekte mennesker som selv har stått i noe av det samme. Ikke terapi. Ikke en bot. Et medmenneske som forstår, fordi de har vært der.",
      "Når støtten ikke kommer fra HR, ikke fra legen og ikke fra nærmeste leder, faller mye av det sosiale stigmaet bort. Folk tar steget tidligere. Og jo tidligere, jo bedre – for dem og for deg.",
      "Som HR-ansvarlig får du aggregert, anonymisert innsikt i hva ansatte faktisk sliter med – slik at du kan jobbe proaktivt, ikke reaktivt. Og Peerlo er tilgjengelig ikke bare for den ansatte, men også for pårørende – fordi livet ikke slutter når arbeidsdagen er over.",
      "## Regnestykket er enkelt",
      "WHO har dokumentert at hver krone investert i psykisk helse gir fire kroner tilbake. ROI på forebyggende helsetiltak er dokumentert til 2–3 ganger investeringen. Peerlo koster en fast månedlig sum per ansatt – forutsigbar, skalerbar, og langt rimeligere enn å håndtere eskalerte saker i etterkant.",
      "Spørsmålet er ikke om dere har råd til det. Spørsmålet er om dere har råd til å la være.",
      "## Hva betyr dette for deg konkret?",
      { items: [
        "Færre langtidssykmeldinger – fordi tidlig intervensjon virker.",
        "Sterkere employer brand – kandidater i 2025 spør om psykisk helse-tilbud allerede i intervjuprosessen.",
        "Støtte til arbeidsmiljølovens krav – §§ 3-1 og 4-3 stiller krav til forebygging av psykiske belastninger. Peerlo er et dokumenterbart tiltak.",
        "Avlastning for deg – ansatte som trenger å snakke, ender ikke nødvendigvis hos deg.",
      ]},
      "## Klar til å gjøre noe med det?",
      "Psykisk uhelse koster norske arbeidsplasser milliarder. Men den egentlige løsningen er ikke bedre sykmeldingsoppfølging. Det er å gjøre det trygt og enkelt å be om hjelp – før man trenger sykmelding.",
      "Det er det Peerlo er bygget for.",
      "[Ta kontakt og hør hvordan Peerlo kan tilpasses din bedrift – uansett størrelse.](/#kontakt)",
      "## Kilder",
      "[Helsedirektoratet (2019), gjengitt i Tidsskrift for Norsk psykologforening (2022). Psykiske lidelser koster Norge 280–290 milliarder kroner i året.](https://www.psykologtidsskriftet.no/artikkel/2022as10ae-Mer-behandling-er-ikke-det-viktigste-)",
      "[NAV (2024). Betydelig økning i sykefraværet i 2. kvartal.](https://www.nav.no/no/nav-og-samfunn/statistikk/sykefravar-statistikk/nyheter/betydelig-okning-i-sykefravaeret-i-2.kvartal--fortsatt-sterk-vekst-i-psykiske-plager)",
      "[NAV (2025). Utviklingen i legemeldt sykefravær – året 2024.](https://www.nav.no/_/attachment/inline/929bb61f-d99c-4edd-881b-dc2439acabc0:5ba00cbca51fa6ec9cbc5e256a198b5f13aa7fcb/%C3%85rsnotat%20sykefrav%C3%A6r%20%C3%A5ret%202024.pdf)",
      "[Folkehelseinstituttet (2023). Psykiske plager og lidelser hos voksne.](https://www.fhi.no/he/fr/folkehelserapporten/psykisk-helse/psykiske-lidelser-voksne/)",
  ...
  {
    slug: "tall-om-psykisk-helse-norge",
    title: "Tall du kanskje ikke visste om psykisk helse i Norge",
    excerpt: "Vi snakker mer om psykisk helse enn noen gang. Men bak samtalene finnes det tall som fortsatt overrasker, og som forteller oss at vi ikke er i mål.",
    date: "2026-05-18",
    author: "Ole Aarre",
    readingTime: 2,
    image: "/images/blog/tall-om-psykisk-helse-norge.png",
    inlineImages: [],
    relatedSlugs: [
    ...
    content: [
      "Vi snakker mer om psykisk helse enn noen gang. Men bak samtalene finnes det tall som fortsatt overrasker, og som forteller oss at vi ikke er i mål.",
      "## Nesten halvparten av oss rammes i løpet av livet",
      "Omtrent halvparten av den voksne norske befolkningen vil rammes av en psykisk lidelse i løpet av livet. Det er ikke snakk om en liten gruppe. Det er kollegaen din, naboen din, kanskje deg selv.",
      "## Hvert år sliter én av fem",
      "Rundt 16–22 prosent av den voksne befolkningen oppfyller kriteriene for en psykisk lidelse i løpet av ett år. Mange av dem søker aldri hjelp.",
      "## Psykiske lidelser er den diagnosegruppen som øker mest",
      "Sykefravær grunnet psykiske lidelser har økt lenge, og utgjorde over 2,2 millioner tapte dagsverk i andre kvartal 2024, over en fjerdedel av alle sykefraværsdagene.",
      "## Og fraværet varer lenge",
      "Sykefravær med psykiske lidelser varer i gjennomsnitt 76,5 dager. Det er nesten tre måneder, og varigheten har økt de siste årene.",
      "## Det er godt nytt også",
      "Det legemeldte sykefraværet falt fra 5,8 prosent i 2024 til 5,5 prosent i 2025, og nedgangen skjedde særlig for diagnosene som økte mest under og etter pandemien. Det viser at det nytter å gjøre noe.",
      "## Tidlig støtte er nøkkelen",
      "WHO har dokumentert at tidlig intervensjon er både mer effektivt og mer kostnadseffektivt enn å vente til krisen er et faktum. Hver krone investert i psykisk helse gir ifølge WHO fire kroner tilbake.",
      "Det betyr at et lavterskeltilbud, som å snakke med noen som har vært der selv, kan utgjøre en reell forskjell. Ikke bare for den det gjelder, men for arbeidsplassen, familien og samfunnet rundt.",
      "## Hva kan du gjøre?",
      "Du trenger ikke vente til det har gått for langt. Hos Peerlo kan du snakke anonymt med noen som forstår, når du trenger det, ikke når systemet har tid til deg.",
      "[Ta det første steget – helt anonymt.](/#cta)",
      "## Kilder",
      "[Folkehelseinstituttet (2018). Psykiske lidelser i Norge – et folkehelseperspektiv.](https://www.fhi.no/publ/eldre/psykiske-lidelser-i-norge-et-folkeh/)",
      "[Folkehelseinstituttet (2023). Psykiske plager og lidelser hos voksne.](https://www.fhi.no/he/fr/folkehelserapporten/psykisk-helse/psykiske-lidelser-voksne/)",
      "[NAV (2024). Betydelig økning i sykefraværet i 2. kvartal.](https://www.nav.no/no/nav-og-samfunn/statistikk/sykefravar-statistikk/nyheter/betydelig-okning-i-sykefravaeret-i-2.kvartal--fortsatt-sterk-vekst-i-psykiske-plager)",
      "[NAV (2025). Nedgang i sykefraværet i 2025.](https://www.nav.no/no/nav-og-samfunn/statistikk/sykefravar-statistikk/nyheter/nedgang-i-sykefravaeret-i-2025)",
      "[World Health Organization (2016). Investing in treatment for depression and anxiety leads to fourfold return.](https://www.who.int/news/item/13-04-2016-investing-in-treatment-for-depression-and-anxiety-leads-to-fourfold-return)",
    ],
  },
  {
  ...
  {
    slug: "tall-psykisk-helse-arbeidsplassen",
    title: "Det koster mer enn du tror – tall om psykisk helse på norske arbeidsplasser",
    excerpt: "Du trenger ikke være ekspert på psykisk helse for å bry deg om disse tallene. Du trenger bare å være ansvarlig for mennesker.",
    date: "2026-05-18",
    author: "Ole Aarre",
    readingTime: 2,
    image: "/images/blog/tall-psykisk-helse-arbeidsplassen.png",
    inlineImages: [],
    relatedSlugs: [
      "hva-koster-darlig-psykisk-helse",
      "slik-beregner-du-psykisk-helse-kostnad",
    ...
    content: [
      "Du trenger ikke være ekspert på psykisk helse for å bry deg om disse tallene. Du trenger bare å være ansvarlig for mennesker.",
      "## 76 dager",
      "Det er den gjennomsnittlige varigheten på et sykefravær med psykisk diagnose i Norge. Ikke en uke. Ikke en måned. Over to og en halv måned, per ansatt, per tilfelle.",
      "Og varigheten øker.",
      "## En av fem ansatte sliter akkurat nå",
      "Rundt 16–22 prosent av den voksne befolkningen oppfyller kriteriene for en psykisk lidelse i løpet av ett år. I en bedrift med 50 ansatte betyr det at opptil ti personer kan slite med noe de ikke har sagt ifra om.",
      "De møter opp. De leverer. Men de har det ikke bra.",
      "## Over en fjerdedel av alle sykefraværsdager",
      "Psykiske lidelser sto for over 2,2 millioner tapte dagsverk bare i andre kvartal 2024, over en fjerdedel av alle sykefraværsdagene i Norge.",
      "Det er ikke en liten utfordring i hjørnet. Det er den største enkeltårsaken til langtidsfravær i norsk arbeidsliv.",
      "## Hjelpen kommer for sent",
      "Forskning fra NKVTS viser at flyktninger i snitt ventet over ti år før de fikk hjelp for traumerelaterte plager. Men det er ikke bare flyktninger som venter. De fleste som sliter psykisk, uansett bakgrunn, venter altfor lenge. Ikke fordi de ikke vil ha hjelp, men fordi terskelen er for høy.",
      "Og jo lenger de venter, jo dyrere blir det. For dem. Og for deg som arbeidsgiver.",
      "## 4 kroner tilbake for hver krone investert",
      "WHO har dokumentert at hver krone investert i behandling av angst og depresjon gir fire kroner tilbake, i form av bedre helse og økt arbeidsevne. Det er ikke veldedighet. Det er én av de beste investeringene en arbeidsgiver kan gjøre.",
      "## Hva gjør du med det?",
      "Tallene er tydelige. Det som er vanskeligere, er å finne tiltak som faktisk når frem, til de ansatte som aldri ville ringt en bedriftshelsetjeneste eller bestilt en time hos psykolog.",
      "Det er derfor Peerlo finnes. Et lavterskeltilbud der ansatte kan snakke anonymt med noen som har vært i samme situasjon, når som helst, uten venteliste, uten at du som arbeidsgiver vet hvem som bruker det.",
      "Du får aggregert innsikt i hva ansatte faktisk sliter med. De får støtte før det går for langt.",
      "[Book en demo og se hvordan Peerlo kan passe inn i din virksomhet.](/#kontakt)",
      "## Kilder",
      "[NAV (2024). Betydelig økning i sykefraværet i 2. kvartal.](https://www.nav.no/no/nav-og-samfunn/statistikk/sykefravar-statistikk/nyheter/betydelig-okning-i-sykefravaeret-i-2.kvartal--fortsatt-sterk-vekst-i-psykiske-plager)",
      "[NAV (2025). Utviklingen i legemeldt sykefravær – året 2024.](https://www.nav.no/_/attachment/inline/929bb61f-d99c-4edd-881b-dc2439acabc0:5ba00cbca51fa6ec9cbc5e256a198b5f13aa7fcb/%C3%85rsnotat%20sykefrav%C3%A6r%20%C3%A5ret%202024.pdf)",
      "[Folkehelseinstituttet (2023). Psykiske plager og lidelser hos voksne.](https://www.fhi.no/he/fr/folkehelserapporten/psykisk-helse/psykiske-lidelser-voksne/)",
  ...
  {
    slug: "nar-spilling-tar-over",
    title: "Når spilling tar over – og du ikke vet hvordan du skal stoppe",
    excerpt: "Du tenkte aldri at det ville gå så langt. Men et sted underveis ble det noe annet. Noe du tenker på hele tiden, planlegger dagen rundt, og som koster mer enn du vil innrømme.",
    date: "2026-05-18",
    author: "Ole Aarre",
    readingTime: 2,
    image: "/images/blog/nar-spilling-tar-over.png",
    inlineImages: [],
    relatedSlugs: [
      "anonymitet-og-apne-seg",
      "aerlig-om-hvordan-man-har-det",
    ...
    content: [
      "Du tenkte aldri at det ville gå så langt.",
      "Det startet kanskje som avkobling. En måte å slappe av på etter en lang dag, eller en flukt fra noe som kjentes for tungt å takle. Men et sted underveis ble det noe annet. Noe du tenker på hele tiden. Noe du planlegger dagen rundt. Noe som koster mer enn du vil innrømme, i penger, i søvn, i relasjoner.",
      "Og nå sitter du kanskje og lurer på om det faktisk er et problem. Det at du googler det, er allerede et svar.",
      "## Skammen er det tyngste",
      "Spillavhengighet er fortsatt et tema mange ikke snakker høyt om. Det er ikke like synlig som andre avhengigheter, og det gjør det lettere å skjule, og vanskeligere å innrømme, også for deg selv.",
      "Mange som sliter med spilling bærer på enorm skam. Skam over pengene som er brukt. Over løgnene som har hopet seg opp. Over følelsen av ikke å ha kontroll over noe som «bare er et spill.» Den skammen gjør at mange venter altfor lenge med å snakke med noen.",
      "## Du trenger ikke ha alt under kontroll for å be om hjelp",
      "En vanlig misforståelse er at man må ha nådd bunnen før man fortjener støtte. Det stemmer ikke. Du trenger ikke ha tapt alt, ødelagt alt eller innrømmet alt, for å ha lov til å snakke med noen.",
      "Det første steget handler ikke om å løse alt på en gang. Det handler bare om å sette ord på det, til ett menneske, én gang. Og hos Peerlo kan du gjøre det helt anonymt. Ingen vet hvem du er. Du bestemmer selv hva du deler.",
      "## Hva peer support kan gi deg",
      "En peer er ikke en terapeut. En peer er et menneske som selv har kjent på det, kanskje tanken som sier «bare én runde til», den konstante indre kampen, eller skammen dagen etter. Noen som vet hvordan det er å sitte med noe du ikke vil at andre skal vite om.",
      "Nettopp derfor betyr anonymiteten så mye. Du kan snakke fritt, uten å bekymre deg for hva det betyr for jobben, forholdet eller hvordan folk ser på deg. Det eneste som skjer, er at du endelig får sagt det høyt.",
      "## Det finnes en vei videre",
      "Spillavhengighet er ikke et karaktertrekk. Det er ikke et tegn på svakhet eller dumhet. Det er noe som kan skje med mennesker som bruker spilling til å håndtere noe annet, stress, ensomhet, tomhet, press.",
      "Og det er noe du kan få hjelp med. Anonymt. Når du er klar.",
      "[Ta det første steget – snakk anonymt med noen som forstår.](/#cta)",
    ],
  },
  {
    slug: "parorende-holde-alt-sammen",
    title: "Når du er den som holder alt sammen – om å være pårørende",
    ...
    content: [
      "Alle snakker om den som er syk. Få snakker om den som står ved siden av.",
      "Pårørende er ofte de mest glemte i hele bildet. De koordinerer, støtter, bekymrer seg og holder fasaden oppe – gjerne på heltid, gjerne i årevis. Og når noen spør hvordan det går, sier de fleste det samme: «Det går bra. Det er ikke jeg det handler om.»",
      "Men det handler også om deg.",
      "## Det koster mer enn folk tror",
      "Å være pårørende er ikke en rolle du søker på. Den bare oppstår. Plutselig er du den som tar telefonen klokken to om natten, følger til legetime og googler diagnoser du aldri visste eksisterte – samtidig som du skal fungere på jobb og late som hverdagen er normal.",
      "Forskning viser at pårørende har betydelig høyere risiko for å utvikle angst, depresjon og utbrenthet enn andre. Likevel er de kraftig underrepresentert blant dem som faktisk får hjelp. Ikke fordi de ikke trenger det – men fordi skyldfølelsen stopper dem. Følelsen av at «jeg har det jo bra sammenlignet med den jeg er glad i.» At man ikke har tid til å ha det dårlig.",
      "Mange pårørende går lenge uten å sette ord på hvordan de egentlig har det. De er så vant til å rette oppmerksomheten utover at de glemmer å kjenne etter innover.",
      "## Derfor kan peer support treffe noe annet",
      "Det er noe spesielt med å snakke med noen som vet hvordan det er. Ikke en terapeut som lytter profesjonelt. Ikke en venn som prøver å forstå, men som egentlig ikke helt gjør det. Men et menneske som selv har stått i rollen som pårørende – og som kjenner igjen følelsen av å bære noe tungt alene.",
      "Du trenger ikke forklare deg fra bunnen av. Du trenger ikke rettferdiggjøre at du sliter. Du kan bare snakke. For mange pårørende er dette det første steget – første gang de tillater seg selv å si høyt at de også trenger noe.",
      "## Du kan ikke gi av noe du ikke har",
      "Jo lenger du ignorerer ditt eget behov for støtte, jo vanskeligere blir det å være den støtten andre trenger deg til å være. Å ta vare på deg selv er ikke egoistisk. Det er nødvendig.",
      "Hos Peerlo møter du noen som har vært der. Som vet hva det vil si å være pårørende – og som møter deg der du er, uten krav og uten journal.",
      "Ta det første steget – snakk med noen som forstår.",
    ],
  },
  {
  ...
  },
  {
    ...
    author: "Ole Aarre",
    readingTime: 1,
    image: "/images/blog/arbeidslivet-og-psykisk-helse.png",
    inlineImages: [],
    relatedSlugs: [
      "aerlig-om-hvordan-man-har-det",
      "anonymitet-og-apne-seg",
